    ...
    <div class="signup-form-container">
      <div class="signup-form">
        ...
        <div class="toggle-buttons">
          <button class="toggle-btn" @click="goToLogin">Log in</button>
...
export default {
  ...
  methods: {
    goToLogin() {
        window.location.href = './LoginPage.vue';
    },
    ...
    // TESTING 
      if (this.name === 'Aysha Shakil' && this.email === 'aysha.shakil@torontomu.ca' && this.password === 'cs') {
      ...
      axios.post('https://your-backend.com/api/signup', userInfo)
        .then(response => {
            // Handle response from the backend.
